  ...
  return (
    <div className="relative flex py-10 px-2 bg-gradient-to-bl from-brandBlue to-white dark:text-[#1E3A8A] p-6">
      <div className="my-auto px-8 max-w-screen-xl mx-auto z-10">
        ...
        {HeroData.map((data) => (
          <div key={data.id}>
            <p className="bg-blue-300 inline-block px-4 py-2 rounded text-xl sm:text-lg lg:text-white text-white sm:text-white mb-4">
              {data.subtitle}
            </p>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white md:text-white lg:text-brandBlue mb-4">
              {data.title}
            </h1>
            <p className="text-lg sm:text-xl text-white md:text-white lg:text-brandBlue mb-6">
              {data.description}
            </p>
            ...
            <div className="pt-6 sm:pt-10">
              <div className="flex ">
                <button
                  ...
                  className="bg-[#FFFFFF] dark:text-[#1E3A8A] py-3 px-6 rounded-xl text-lg sm:text-base"
                >
                  Get Started
                </button>
              </div>
      ...
      <div className="w-full max-w-[1300px] mx-auto lg:block hidden relative">
        <img
          src={HeroImage}
          alt="Hero"
