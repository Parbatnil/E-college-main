...
import { WbjecaSub } from "../../../assets/Wbjeca";
const TeacherJecaExam = () => {
  ...
  const handelPublish = (_id) => {
    ...
    if (confirm) {
      axios
        .put(`https://courseapi-3kus.onrender.com/api/courseexam/${_id}`, {
          status: true,
        })
        .then((res) => {
          setPub(true);
  ...
  const handelDelete = (_id) => {
    ...
    if (confirm) {
      axios
        .delete(`https://courseapi-3kus.onrender.com/api/courseexam/${_id}`)
        .then((res) => {
                        ...
                        {records
                          ...
                          .map((d, i) => (
                            <tr key={i}>
                              ...
                              {d.status ? (
                                <td className="border-2 border-gray-400 p-2 rounded-md w-80 sm:w-auto bg-green-500 cursor-pointer">
                                  Live
                                </td>
                              ) : (
                                <td
                                  className="border-2 border-gray-400 p-2 rounded-md w-80 sm:w-auto bg-yellow-200 cursor-pointer"
                                  onClick={(e) => handelPublish(d._id)}
                                >
                                  Pub
                                </td>
                              )}
...
export default TeacherJecaExam;
