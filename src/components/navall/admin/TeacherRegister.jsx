  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://courseapi-3kus.onrender.com/api/register-teacher",
        formData
      );
    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen  bg-white">
        ...
        <form
          ...
          className="bg-gray-400 mb-4 rounded-xl p-6 shadow-md space-y-4"
        >
          <div>
        ...
        {registerNumber && (
          <p className="mt-4">Registered Number: {registerNumber}</p>
        )}
      </div>
    </>
  );
